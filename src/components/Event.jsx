...
import trident from "../assets/trident.mp4"

export default function Event() {
  return (
    <>
    <h1 className="text" id="event-heads">Events</h1>
      <div className="card-con">
        <div className="event-card">
          ...
          <div className="text-con">
            <h1 className="text" id="event-head">Innovate@Trix</h1>
            <h2 className="text" id="desc">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quaerat, laborum commodi! Quod labore corrupti numquam veritatis maxime. Fugiat, odio hic?</h2>
          </div>
        </div>
        <div className="event-card">
          <div className="vid-con">
